...
const categories = [
  {
    ...
    description: 'Premium drivers from top manufacturers for maximum distance and accuracy',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/drivers.jpg',
    count: '24 products',
  ...
  },
  {
    ...
    description: 'Professional-grade iron sets for precision and control',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/irons.jpg',
    count: '18 products',
  ...
  },
  {
    ...
    description: 'Premium putters including collectible and custom models',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/putters.jpg',
    count: '32 products',
  ...
  },
  {
    ...
    description: 'Specialized wedges for short game mastery',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/wedges.jpg',
    count: '15 products',
  ...
  },
  {
    ...
    description: 'Versatile fairway woods for all course conditions',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/fairway-woods.jpg',
    count: '12 products',
    brands: ['Titleist', 'Callaway', 'TaylorMade', 'Ping']
  },
  {
  ...
  },
  {
    ...
    description: 'Essential golf accessories and equipment',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/accessories.jpg',
    count: '45 products',
    brands: ['Various']
  },
  {
    ...
    description: 'Rare and vintage golf equipment for collectors',
           image: 'https://king-covy-assets.s3.amazonaws.com/categories/collectibles.jpg',
    count: '28 products',
