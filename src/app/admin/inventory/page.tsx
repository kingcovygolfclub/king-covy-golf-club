  ...
  const handleAddItem = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const imageUrls = imagePreviewUrls.length > 0 
        ? imagePreviewUrls 
        : ['https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg']; // Default placeholder
      ...
      const itemData: Partial<InventoryItem> = {
        ...
        totalCost,
        images: imageUrls,
        primaryImage: newItem.primaryImage || imageUrls[0] || 'https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString()
      };
      ...
      if (response.success && newItem.itemType === 'product') {
        try {
          const productData = {
            ...
            images: itemData.images || ['https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg'],
