      ...
      if (response.success && response.data) {
        ...
        const normalizedItems: InventoryItem[] = response.data.map((item: any) => ({
          ...
          itemType: item.itemType || 'product',
            images: item.images || ['https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg'],
            primaryImage: item.primaryImage || item.images?.[0] || 'https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg',
        ...
        if (productsResponse.success && productsResponse.data) {
          ...
          const transformedItems: InventoryItem[] = productsResponse.data.map((product: any) => ({
            ...
            images: product.images || ['https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg'],
            primaryImage: product.images?.[0] || 'https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg',
  ...
  const handleAddItem = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const imageUrls = imagePreviewUrls.length > 0 
        ? imagePreviewUrls 
             : ['https://king-covy-assets.s3.amazonaws.com/products/drivers/generic-driver.jpg']; // Default placeholder
      ...
      const itemData: Partial<InventoryItem> = {
        ...
        totalCost,
        images: imageUrls,
             primaryImage: newItem.primaryImage || imageUrls[0] || 'https://king-covy-assets.s3.amazonaws.com/products/drivers/generic-driver.jpg',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString()
      };
        ...
        try {
          const productData = {
            ...
            originalPrice: (itemData.totalCost || 0) * 1.6, // Higher original price
                 images: itemData.images || ['https://king-covy-assets.s3.amazonaws.com/products/drivers/generic-driver.jpg'],
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <img
                          src={item.primaryImage || item.images?.[0] || 'https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg'}
                          alt={`${item.brand} ${item.model}`}
                          className="w-12 h-12 object-cover rounded-lg border"
                          onError={(e) => {
                            e.currentTarget.src = 'https://king-covy-assets.s3.amazonaws.com/products/placeholder-golf-club.svg';
                          }}
                        />
                      </div>
                      {/* Brand/Model Info */}
